...
class EquityState:
    ...
    def handle_trade_settlement(
        ...
        *,
        ...
        self.tradable_capital = max(self.available_capital, self.initial_capital * 0.01)
        return self.total_assets() < ruin_threshold

    def total_assets(self) -> float:
        """가용 자본, 저축, 잠긴 자본을 모두 더한 총 자산을 반환합니다."""

        return self.available_capital + self.savings + self.locked_capital
